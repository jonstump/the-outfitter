...
4. Equipment drag and drop settled — shipped, not settled. Both blockers (#352/#353) and #419 closed 2026-08-15 (PR #430); #382 closed 2026-08-16 (PR #440); #363 closed 2026-08-16 (PR #452) — its "fix" turned out to be correcting the issue's own stale premise: `slotMax` wasn't dead code (issue #363 said delete it), #353 had already wired it into the live `equipOverCapacity` path, so the actual fix was deduping its blocked-cell count to match `hasFreeCell` instead. #241 remains, the last blocker.
